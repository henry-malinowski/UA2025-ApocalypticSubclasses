const MODULE_ID = "UA2025-ApocalypticSubclasses";

Hooks.once("init", () => {
	CONFIG.DND5E.featureTypes.class.subtypes.brutalityEffect = "Brutality Effect";
	...
	console.log("ua2025-apocalyptic-subclasses.mjs hooked");
});
...
Hooks.once("ready", async () => {
	...
	if (foundry.utils.isNewerVersion(currentVersion, lastVersion)) {
		const journal = await fromUuid(
			"Compendium.UA2025-ApocalypticSubclasses.content.JournalEntry.uaChangelog00000",
		);
